...
function inserir(livro) {
    if(livro && livro.nome && livro.autor && livro.editora && livro.anoPublicacao) {
        ...
        throw {id:400, message:"Livro não possui nome, autor, editora ou o seu ano de publicação!"};
    }
}
...
function devolverLivro(id) {
    ...
    if(livro) {
        if (livro.disponivel == false) {
            ...
            throw {id:400, message:"O livro que você está tentando devolver já consta na nossa base de dados!"}
        }
    } else {
        throw {id:404, message:"Livro não encontrado!"}
    }
